...
const SortableGalleryItem = ({
  ...
  return (
    ...
    >
      ...
      <span className="absolute top-0 right-0 bg-pink-600 text-white text-xs font-bold px-2 py-1 rounded-bl-lg">
        GALLERY
      </span>

      {/* ❌ REMOVE (STOP DRAG HERE) */}
      <button
        type="button"
...
const AddProductPage = () => {
  ...
  const resetForm = () => {
    setProductData({
      ...
      productTag: '',
      variants: [],
      shippingCharge: '', // NEW FIELD: reset shipping charge
    });
    setNewVariant({ color: '', size: '', price: '', offerPrice: '', stock: '' });
  ...
  // --- SUBMIT HANDLER (UPDATED for modal logic and shipping charge) ---
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const productToSave = {
        ...
        shippingCharge: productData.shippingCharge ? parseFloat(productData.shippingCharge) : 0,
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-0 focus:border-gray-200"
                  disabled={isFormDisabled}
                />
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-gray-800 flex items-center">
                <FiTruck className="w-6 h-6 mr-3 text-indigo-600" />
              ...
              <p className="text-sm text-gray-500 mt-1">Enter the shipping charge for this product. Leave empty or set to 0 for free shipping.</p>
            </div>
